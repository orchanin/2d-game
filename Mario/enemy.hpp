...
public:
    ...
    void update(float time)
    {
        ...
        {
            /*
            все 0.002, 0.03 и прочие числа нужно вынести в отдельные константы
            */
            dx = 0.03;
        }
        
        /*
        у вас переменные названы так, что не сходится размерность: м += м * с
        переименуйте, чтобы соответствовало
        */
        x += dx * time;
    ...
    /*
    в названии методов должен быть глагол.
    мы в прошлом семестре говорили об этом. проверьте код на соответствие тем требованиям.
    */
